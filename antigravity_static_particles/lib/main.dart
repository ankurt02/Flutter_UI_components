...
class AntigravityJellyfishPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // The Jellyfish Background Layer
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        //  Return Painter with fixed center (No MouseRegion)
        return CustomPaint(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var origin in points) {
      ...
      if (dist > contractionRadius) {
        ...
        // Strong pull so dots clearly move inward at borders
